...
from gear_sonic.envs.manager_env.robots import g1, h2, vr_h3_1
...
class ModularTrackingEnvCfg(ManagerBasedRLEnvCfg):
    ...
    def override_settings(self):
        ...
        robot_mapping = {
            ...
            "vr_h3_1": {
                "robot_cfg": vr_h3_1.VR_H3_1_CFG,
                "action_scale": vr_h3_1.VR_H3_1_ACTION_SCALE,
                "isaaclab_to_mujoco_mapping": vr_h3_1.VR_H3_1_ISAACLAB_TO_MUJOCO_MAPPING,
            },
        }
