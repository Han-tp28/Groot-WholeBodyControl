...
class VRH31Converter(IsaacLabMuJoCoConverter):
    """VR H3.1 robot joint/body order converter between IsaacLab and MuJoCo conventions."""

    def __init__(self):
        from gear_sonic.envs.manager_env.robots.vr_h3_1 import (
            VR_H3_1_ISAACLAB_JOINTS,
            VR_H3_1_ISAACLAB_TO_MUJOCO_BODY,
            VR_H3_1_ISAACLAB_TO_MUJOCO_DOF,
            VR_H3_1_MUJOCO_TO_ISAACLAB_BODY,
            VR_H3_1_MUJOCO_TO_ISAACLAB_DOF,
        )

        self.JOINT_NAMES = VR_H3_1_ISAACLAB_JOINTS
        self.DOF_MAPPINGS = {
            ("isaaclab", "mujoco"): VR_H3_1_ISAACLAB_TO_MUJOCO_DOF,
            ("mujoco", "isaaclab"): VR_H3_1_MUJOCO_TO_ISAACLAB_DOF,
        }
        self.BODY_MAPPINGS = {
            ("isaaclab", "mujoco"): VR_H3_1_ISAACLAB_TO_MUJOCO_BODY,
            ("mujoco", "isaaclab"): VR_H3_1_MUJOCO_TO_ISAACLAB_BODY,
        }
